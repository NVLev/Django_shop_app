...
from django.conf.global_settings import LOGIN_REDIRECT_URL, LOGIN_URL, LANGUAGES, LOGGING, INTERNAL_IPS
...
SECRET_KEY = getenv(
    "DJANGO_SECRET_KEY",
    'django-insecure-43lw8v-)9c%$^xi-1$j4njrv=&78lnwo*+q-si99#o%b*cgjsw'
)
